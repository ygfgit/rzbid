...
export default class JfWorkDetails extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllJfWorkDetailss();
  }
  ...
  public retrieveAllJfWorkDetailss(): void {
  ...
  public prepareRemove(instance: IJfWorkDetails): void {
  ...
  public removeJfWorkDetails(): void {
    this.jfWorkDetailsService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('rzbidApp.jfWorkDetails.deleted', { param: this.removeId });
