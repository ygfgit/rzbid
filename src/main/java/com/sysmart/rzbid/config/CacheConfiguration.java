package com.sysmart.rzbid.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.sysmart.rzbid.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.sysmart.rzbid.repository.UserRepository.USERS_BY_EMAIL_CACHE);
